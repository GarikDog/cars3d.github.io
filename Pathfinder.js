...
function load() {
  var preloader_cont = document.getElementById("circle");             // Parse!!!!!!!!
    ...
    m_data.load(APP_ASSETS_PATH + "Pathfinder.json", load_cb, preloader_cb); // CAR JSON ATTENTION!
}
//P
//R
//E
...
if(matType == 1) {
 ...
 calc = document.getElementById("calcPanel").innerHTML = 'Колер хамелеон "MARUSYA" на 2 литра - 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 25 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
}
if(matType == 0) {
 ...
 Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
  Черная матовая база густая резина 1 литр - 7 шт.<br>\
  Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 25 шт.<br>\
  Эластичный полиуретановый лак "Goodлак" Глянцевый - 6 шт.<br>' + buy;
}
if(matType == 2) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0.5);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 1);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер хамелеон "MARUSYA" на 2 литра - 3 шт.<br>\
Сверхпрочное полиуретановое покрытие ТИТАН (Черный глянец) + 1 отвердитель - 5 шт.<br>\
Сверхпрочное полиуретановое покрытие ТИТАН (Колеруемая база) + 1 отвердитель - 6 шт.<br>' + buy;
         }
    }
...
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 8 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 25 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
}
if(matType == 0) {
...
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 8 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Глянцевый - 5 шт.<br>' + buy;
}
if(matType == 2) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 1);
...
if(matType == 2) {
 ...
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 1);
 calc = document.getElementById("calcPanel").innerHTML = 'Красный перламутр колер  - 8 шт.<br>\
Сверхпрочное полиуретановое покрытие ТИТАН (Черный глянец) + 1 отвердитель - 6 шт.<br>\
Сверхпрочное полиуретановое покрытие ТИТАН (Колеруемая база) + 1 отвердитель - 5 шт.<br>' + buy;
         }
}
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер перламутровый "BAIKAL"  - 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер перламутровый "DESERT"  - 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер перламутровый "JUNGLE"  - 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер перламутровый "KOKA"  - 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Глянцевый - 4 шт.<br>' + buy;
}
if(matType == 0) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 1);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер перламутровый "LEMON" - 4 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 7 шт.<br>\
Черная матовая база густая резина 1 литр - 6 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
}
if(matType == 0) {
...
if(matType == 2) {
 ...
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 1);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер перламутровый "LEMON"  - 4 шт.<br>\
Сверхпрочное полиуретановое покрытие ТИТАН (Черный глянец) + 1 отвердитель - 7 шт.<br>\
Сверхпрочное полиуретановое покрытие ТИТАН (Колеруемая база) + 1 отвердитель - 7 шт.<br>' + buy;
         }
}
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер перламутровый "LIME" - 4 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 7 шт.<br>\
Черная матовая база густая резина 1 литр - 6 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер перламутровый "PRAGA"- 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер перламутровый "URBAN"- 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер хамелеон "AMNEZIA"- 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер хамелеон "BARCA"- 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер хамелеон "KATRIN"- 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер хамелеон "SECRET"- 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер хамелеон "RED FIRE" - 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер хамелеон "ORANGE FIRE" - 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер хамелеон "LILI’ - 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
...
Белая матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
}
if(matType == 0) {
...
if(matType == 2) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 1);
 calc = document.getElementById("calcPanel").innerHTML = 'Сверхпрочное полиуретановое покрытие ТИТАН (Колеруемая база) + 1 отвердитель - 11 шт.<br>\
Белый колер для покрытия Титан на 1 литр - 11 шт.<br>' + buy;
         }
}
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Черная матовая база густая резина 1 литр - 12 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
}
if(matType == 0) {
...
if(matType == 2) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 1);
 calc = document.getElementById("calcPanel").innerHTML = 'Сверхпрочное полиуретановое покрытие ТИТАН (Черный глянец) + 1 отвердитель - 11 шт.<br>' + buy;
         }
}
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Серая матовая база густая резина 1 литр - 12 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 27 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 4 шт.<br>' + buy;
}
if(matType == 0) {
...
if(matType == 2) {
 ...
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 1);
 calc = document.getElementById("calcPanel").innerHTML = 'Сверхпрочное полиуретановое покрытие ТИТАН (Колеруемая база) + 1 отвердитель - 11 шт.<br>\
Темно-серый колер для покрытия Титан на 1 литр - 11 шт.<br>' + buy;
         }
}
