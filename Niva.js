...
function load() {
  var preloader_cont = document.getElementById("circle");             // Parse!!!!!!!!
    ...
    m_data.load(APP_ASSETS_PATH + "Niva.json", load_cb, preloader_cb); // CAR JSON ATTENTION!
}
//P
//R
//E
...
Прозрачная глянцевая база густая резина 1 литр для колеров - 4 шт.<br>\
Черная матовая база густая резина 1 литр - 7 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 22 шт.<br>\
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Золотой перламутр колер  - 6 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 3 шт.<br>\
Черная матовая база густая резина 1 литр - 6 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 19 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 3 шт.<br>' + buy;
}
if(matType == 0) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 1);
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Красный перламутр колер  - 6 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 3 шт.<br>\
Черная матовая база густая резина 1 литр - 6 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 19 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 3 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Сине-фиолетовый перламутр колер  - 6  шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 3 шт.<br>\
Черная матовая база густая резина 1 литр - 6 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 19 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 3 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Серебряный перламутр колер  - 6 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 3 шт.<br>\
Черная матовая база густая резина 1 литр - 6 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 19 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 3 шт.<br>' + buy;
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер перламутровый "LEMON" - 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 5 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 22 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 3 шт.<br>' + buy;
}
if(matType == 0) {
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Колер перламутровый "LIME" - 3 шт.<br>\
Прозрачная глянцевая база густая резина 1 литр для колеров - 6 шт.<br>\
Черная матовая база густая резина 1 литр - 6 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 22 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 3 шт.<br>' + buy;
...
Прозрачная глянцевая база густая резина 1 литр для колеров - 4 шт.<br>\
Черная матовая база густая резина 1 литр - 6 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 20 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 3 шт.<br>' + buy;
}
if(matType == 0) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 1);
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Серая матовая база густая резина 1 литр - 4 шт.<br>\
Белая матовая база густая резина 1 литр - 5 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 20 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 3 шт.<br>' + buy;
}
if(matType == 0) {
...
if(matType == 2) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 1);
 calc = document.getElementById("calcPanel").innerHTML = 'Сверхпрочное полиуретановое покрытие ТИТАН (Колеруемая база) + 1 отвердитель - 9 шт.<br>\
Белый колер для покрытия Титан на 1 литр - 9 шт.<br>' + buy;
         }
}
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Черная матовая база густая резина 1 литр - 9 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 20 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 3 шт.<br>' + buy;
}
if(matType == 0) {
...
if(matType == 2) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 1);
 calc = document.getElementById("calcPanel").innerHTML = 'Сверхпрочное полиуретановое покрытие ТИТАН (Черный глянец) + 1 отвердитель - 9 шт.<br>' + buy;
         }
}
...
if(matType == 1) {
 m_mat.set_nodemat_value(Ocar, ["Marusia", "gloss"], 0);
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 0);
 calc = document.getElementById("calcPanel").innerHTML = 'Серая матовая база густая резина 1 литр - 9 шт.<br>\
Разбавитель для жидкой резины, лака, ТИТАНа 1 литр - 20 шт.<br>\
Эластичный полиуретановый лак "Goodлак" Матовый - 3 шт.<br>' + buy;
}
if(matType == 0) {
...
if(matType == 2) {
 ...
 m_mat.set_nodemat_value(Ocar, ["Marusia", "NormalM"], 1);
 calc = document.getElementById("calcPanel").innerHTML = 'Сверхпрочное полиуретановое покрытие ТИТАН (Колеруемая база) + 1 отвердитель - 9 шт.<br>\
Темно-серый колер для покрытия Титан на 1 литр - 9 шт.<br>' + buy;
         }
}
